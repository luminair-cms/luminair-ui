...
import {
  ...
  coerceValue,
  getTypeName,
} from '@/components/CreateDocumentDrawer/index';
          ...
          <Space>
            ...
            {!isNew && schema.options?.draftAndPublish && (
              <Button
                ...
                style={{ background: documentStatus !== 'published' ? '#10b981' : undefined, color: documentStatus !== 'published' ? '#fff' : undefined, borderColor: documentStatus !== 'published' ? '#10b981' : undefined }}
              >
                Publish
              </Button>
            )}
